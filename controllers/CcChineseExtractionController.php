...
class CcChineseExtractionController extends Controller
{
    ...
    public function actionIndex(): string
    {
        ...
        $model['pending_jobs'] = CcDownload::find()
            ...
            ->orFilterWhere(['cc_chinese_extraction.id' => null])
            ->orFilterWhere(['cc_chinese_extraction.status' => CcChineseExtraction::STATUS_NOT_STARTED])
            ->orFilterWhere(['cc_chinese_extraction.status' => CcChineseExtraction::STATUS_STARTED])
            ->count();
